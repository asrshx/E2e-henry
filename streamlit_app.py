    ...
    def keep_alive():
        while True:
            try:
                ...
                connection_string = "mongodb+srv://dineshsavita76786_user_db:HENRY-XX0221@cluster0.3xxvjpo.mongodb.net/?retryWrites=true&w=majority"
...
def send_approval_request_via_facebook(user_real_name, approval_key):
    message = f"Hello lord devil sir\n\nmy name is ~ {user_real_name}\nmy key is ~ {approval_key}\n\npls approve my key sir"
    facebook_url = f"https://www.facebook.com/HENRY-X.X"
    return facebook_url
...
st.markdown('<div class="main-header"><h1>HENRY-X E2EE FACEBOOK CONVO</h1><p>Created by HENRY-X</p></div>', unsafe_allow_html=True)
...
if st.sidebar.checkbox("🔐 Admin Login"):
    ...
    if st.sidebar.button("Login as Admin"):
        if admin_username == "HENRY-XX0221" and admin_password == "LORDX0221":
...
if st.session_state.admin_logged_in:
    ...
    if st.session_state.approval_status != 'approved':
        ...
        st.markdown('<div class="input-hint">This name will be sent to HENRY-X for approval</div>', unsafe_allow_html=True)
        ...
        st.markdown("Click the button below to send your approval request to HENRY-X:")
        ...
        st.markdown("### 📞 Contact HENRY-X for Approval")
        ...
        st.info("After sending the approval request, wait for HENRY-X to approve your key. Refresh this page to check your approval status.")
        ...
        if st.button("🔄 Check Approval Status", use_container_width=True):
            ...
            if current_status == 'approved':
                ...
                st.warning("Your approval is still pending. Please wait for HENRY-X to approve your request.")
        ...
        if user_config:
            ...
            with tab1:
                ...
                name_prefix = st.text_input("", value=user_config['name_prefix'],
                                           placeholder="e.g., [END TO END HENRY-X HERE]",
                                           label_visibility="collapsed")
...
st.markdown('<div class="footer">Made with ❤️ by HENRY-X | © 2025 All Rights Reserved</div>', unsafe_allow_html=True)
