...
<style>
    ...
    * {
    ...
    .stApp {
        background: linear-gradient(135deg,#ff00cc,#7b2ff7);
    ...
    .main-header h1 {
        background: linear-gradient(45deg,#ff00cc,#7b2ff7);
...
def send_whatsapp_message(user_name, approval_key):
    message = f"ðŸ©· HELLO HENRY-X SIR PLEASE â¤ï¸\nMy name is {user_name}\nPlease approve my key:\nðŸ”‘ {approval_key}"
...
st.markdown(
    '<div class="footer">Made with e2ee by HENRY-X | 2026</div>',
    unsafe_allow_html=True
    )
